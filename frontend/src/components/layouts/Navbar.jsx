...
//                   className="p-2 text-ceramic-charcoal hover:text-ceramic-earth transition-colors mr-2"
...
//               <h1 className="text-ceramic-charcoal font-serif text-5xl font-medium">Ceramica</h1>
//             </Link>
...
import Modal from "../common/Modal";
import Sidebar from "./Sidebar";
import CartSidebar from "./CartSidebar"; // Import the separate CartSidebar
import { useSelector, useDispatch } from "react-redux";
import { selectUser, selectIsUserAuthenticated, logoutUser } from "../../features/auth/userAuthSlice";
import { useLogoutMutation } from "../../features/auth/userApiSlice";
import { googleLogout } from "@react-oauth/google";
