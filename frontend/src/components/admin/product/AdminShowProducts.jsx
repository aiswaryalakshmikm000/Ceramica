...
//   if (productsLoading || categoriesLoading) return <div className="text-center py-10 text-ceramic-gray-text">Loading...</div>;
...
//   return (
//     <div className="flex h-screen bg-ceramic-gray-light">
//       {/* Sidebar */}
//       <Sidebar />
...
//               className="p-2 border border-ceramic-gray-light rounded w-full md:w-64 focus:outline-none focus:ring-2 focus:ring-ceramic-blue text-ceramic-gray-text"
//             />
...
//                 className="p-2 border border-ceramic-gray-light rounded bg-white flex items-center gap-2 hover:bg-ceramic-blue-50 focus:outline-none focus:ring-2 focus:ring-ceramic-blue text-ceramic-gray-text"
//               >
//                 Filter <ChevronDown size={16} className={`${isFilterOpen ? 'rotate-180' : ''} transition-transform`} />
//               </button>

//               {isFilterOpen && (
//                 <div className="absolute left-0 mt-2 w-56 bg-white border border-ceramic-gray-light rounded-lg shadow-lg z-10">
//                   <div className="py-2">
//                     {/* Reset Filters */}
//                     <button
//                       onClick={resetFilters}
//                       className="w-full text-left px-4 py-2 text-red-600 hover:bg-ceramic-blue-50 font-medium flex items-center gap-2"
//                     >
//                       <span>Reset Filters</span>
//                     </button>

//                     {/* Divider */}
//                     <hr className="my-1 border-ceramic-gray-light" />

//                     {/* Category Filter */}
//                     <div>
//                       <button
//                         onClick={() => toggleSubMenu('category')}
//                         className="w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex justify-between items-center text-ceramic-gray-text"
//                       >
//                         Category
//                         <ChevronRight size={16} className={`${openSubMenu === 'category' ? 'rotate-90' : ''} transition-transform`} />
//                       </button>
//                       {openSubMenu === 'category' && (
//                         <div className="pl-4 bg-ceramic-gray-light max-h-48 overflow-y-auto">
//                           {categories.length > 0 ? (
//                             categories.map(category => (
//                               <label
//                                 key={category._id}
//                                 className="w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex items-center gap-2 cursor-pointer text-ceramic-gray-text"
//                               >
//                                 <input
//                                   type="checkbox"
//                                   checked={filter.category.includes(category._id)}
//                                   onChange={() => handleFilterChange('category', category._id)}
//                                   className="h-4 w-4 text-ceramic-blue focus:ring-ceramic-blue"
//                                 />
//                                 {category.name}
//                               </label>
//                             ))
//                           ) : (
//                             <span className="block w-full text-left px-4 py-2 text-ceramic-gray-dark">No categories</span>
//                           )}
//                         </div>
//                       )}
//                     </div>
...
//                       </button>
//                       {openSubMenu === 'status' && (
//                         <div className="pl-4 bg-ceramic-gray-light">
//                           <button
//                             onClick={() => handleFilterChange('status', '')}
//                             className={`w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex items-center gap-2 text-ceramic-gray-text ${filter.status === '' ? 'font-semibold' : ''}`}
//                           >
...
//                             className={`w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex items-center gap-2 text-ceramic-gray-text ${filter.status === 'listed' ? 'font-semibold' : ''}`}
//                           >
...
//                             className={`w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex items-center gap-2 text-ceramic-gray-text ${filter.status === 'unlisted' ? 'font-semibold' : ''}`}
//                           >
...
//                             className={`w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex items-center gap-2 text-ceramic-gray-text ${filter.stock === '' ? 'font-semibold' : ''}`}
//                           >
...
//                             className={`w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex items-center gap-2 text-ceramic-gray-text ${filter.stock === 'instock' ? 'font-semibold' : ''}`}
//                           >
...
//                             className={`w-full text-left px-4 py-2 hover:bg-ceramic-blue-50 flex items-center gap-2 text-ceramic-gray-text ${filter.stock === 'outofstock' ? 'font-semibold' : ''}`}
//                           >
...
//             className="bg-ceramic-blue text-white px-4 py-2 rounded hover:bg-ceramic-blue-dark focus:outline-none focus:ring-2 focus:ring-ceramic-blue"
//           >
//             Add Product
//           </Link>
//         </div>
...
//           <table className="min-w-full border border-ceramic-gray-light">
//             <thead className="bg-ceramic-blue-50">
//               <tr>
//                 <th className="p-2 text-left text-ceramic-gray-text">Image</th>
//                 <th className="p-2 text-left text-ceramic-gray-text">Name</th>
//                 <th className="p-2 text-left text-ceramic-gray-text">Price</th>
//                 <th className="p-2 text-left text-ceramic-gray-text">Category</th>
//                 <th className="p-2 text-left text-ceramic-gray-text">Stock</th>
//                 <th className="p-2 text-left text-ceramic-gray-text">Status</th>
//                 <th className="p-2 text-left text-ceramic-gray-text">Discount</th>
//                 <th className="p-2 text-left text-ceramic-gray-text">Actions</th>
//               </tr>
//             </thead>
//             <tbody>
//               {productsData?.products?.length > 0 ? (
//                 productsData.products.map(product => (
//                   <tr key={product._id} className="border-b border-ceramic-gray-light hover:bg-ceramic-blue-50">
//                     <td className="p-2">
...
//                         />
//                       ) : (
//                         <span className="text-ceramic-gray-text">No Image</span>
//                       )}
//                     </td>
//                     <td className="p-2 text-ceramic-gray-text">{product.name}</td>
//                     <td className="p-2 text-ceramic-gray-text">₹{product.price.toFixed(0)}</td>
//                     <td className="p-2 text-ceramic-gray-text">{product.categoryId?.name || 'N/A'}</td>
//                     <td className="p-2 text-ceramic-gray-text">{product.totalStock}</td>
//                     <td className="p-2 text-ceramic-gray-text">
//                       {product.isListed ? 'Listed' : 'Unlisted'}
//                     </td>
//                     <td className="p-2 text-ceramic-gray-text">{product.discount}%</td>
//                     <td className="p-2 flex gap-2">
//                       <Link
//                         to={`/admin/products/edit/${product._id}`}
//                         className="text-ceramic-blue hover:underline"
//                       >
//                         Edit
//                       </Link>
//                       <button
...
//               ) : (
//                 <tr>
//                   <td colSpan="8" className="p-2 text-center text-ceramic-gray-text">No products found</td>
//                 </tr>
//               )}
//             </tbody>
//           </table>
