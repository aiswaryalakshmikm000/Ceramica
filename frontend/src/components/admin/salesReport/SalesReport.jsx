...
const SalesReport = () => {
  ...
  const handleDownloadReport = async (format) => {
    try {
      ...
      const blob = response; // Response is already a blob due to responseHandler
            ...
            <div className="flex flex-row gap-4 sm:items-center">
                  ...
                  <div className="absolute left-0 mt-2 w-48 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                    <div className="py-2">
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 hover:bg-gray-100 ${dateFilter === "day" ? "font-semibold text-[#3c73a8]" : "text-gray-700"}`}
                      >
                        Daily
                      </button>
                      <button
                        onClick={() => handleDateFilterChange("week")}
                        className={`w-full text-left px-4 py-2 hover:bg-gray-100 ${dateFilter === "week" ? "font-semibold text-[#3c73a8]" : "text-gray-700"}`}
                      >
                        Weekly
                      </button>
                      <button
                        onClick={() => handleDateFilterChange("month")}
                        className={`w-full text-left px-4 py-2 hover:bg-gray-100 ${dateFilter === "month" ? "font-semibold text-[#3c73a8]" : "text-gray-700"}`}
                      >
                        Monthly
                      </button>
                      <button
                        onClick={() => handleDateFilterChange("year")}
                        className={`w-full text-left px-4 py-2 hover:bg-gray-100 ${dateFilter === "year" ? "font-semibold text-[#3c73a8]" : "text-gray-700"}`}
                      >
                        Yearly
                      </button>
                    </div>
              ...
              <div className="flex border border-gray-300 rounded-md overflow-hidden">
                <button
                  ...
                  className={`p-2 ${chartType === "bar" ? "bg-[#3c73a8] text-white" : "bg-white text-gray-700 hover:bg-gray-100"}`}
                  title="Bar Chart"
                >
                  <BarChart4 size={18} />
                </button>
                <button
                  ...
                  className={`p-2 ${chartType === "line" ? "bg-[#3c73a8] text-white" : "bg-white text-gray-700 hover:bg-gray-100"}`}
                  title="Line Chart"
                >
                  <LineChart size={18} />
                </button>
                <button
                  ...
                  className={`p-2 ${chartType === "pie" ? "bg-[#3c73a8] text-white" : "bg-white text-gray-700 hover:bg-gray-100"}`}
                  title="Pie Chart"
                >
                  <PieChart size={18} />
                </button>
