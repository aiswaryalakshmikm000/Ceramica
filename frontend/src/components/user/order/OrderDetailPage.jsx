            ...
            {canReturn && (
              <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
                ...
                <Button
                  ...
                  className="bg-orange-800/90 hover:bg-orange-800 mt-3 text-white"
                >
                  Submit Return
                </Button>
              </div>
            ...
            {canCancel && (
              <div className="bg-gray-50 rounded-lg p-4 shadow-sm">
                ...
                <Textarea
                  ...
                  className="w-full mb-3 border-gray-200 focus:ring-orange-800/30"
                />
                <Button
                  onClick={handleCancel}
                  className="bg-orange-800/90 hover:bg-orange-800 text-white"
                >
                  Cancel Order
                </Button>
              </div>
