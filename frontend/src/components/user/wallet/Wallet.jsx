      ...
      <div className="mx-auto">
        <div className="bg-white rounded-2xl shadow-md p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-800">My Wallet</h2>
          </div>
          <Breadcrumbs items={breadcrumbItems} />

          {/* Balance Card */}
          <div className="bg-gradient-to-r from-orange-800 to-gray-900 rounded-xl text-white p-4 sm:p-6 mt-6 shadow-lg">
            <div className="flex flex-col sm:flex-row justify-between items-start">
              <div>
                <h2 className="text-xl sm:text-2xl font-medium text-gray-300">Current Balance</h2>
                <div className="text-2xl sm:text-3xl font-bold mt-2">₹{balance.toFixed(2)}</div>
              </div>
              <CreditCard size={32} className="text-gray-300 mt-4 sm:mt-0" />
            </div>

            <div className="flex mt-6 sm:mt-8">
              <button
                onClick={() => setIsAddingFunds(true)}
                className="bg-white text-gray-900 px-3 py-2 sm:px-4 sm:py-2 rounded-md flex items-center text-sm hover:bg-gray-100 transition-colors"
              ...
              <form onSubmit={handleAddFunds} className="mt-4">
                <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                  <input
                    ...
                    min="1"
                    step="1"
                    className="flex-grow p-2 rounded-md border border-gray-300 text-gray-900 w-full sm:w-auto"
                    aria-label="Amount to add"
                    required
                  />
                  <button
                    type="submit"
                    className="bg-green-600 text-white px-4 py-2 rounded-md text-sm hover:bg-green-700 transition-colors disabled:bg-green-400 w-full sm:w-auto"
                  ...
                  <button
                    ...
                    className="bg-gray-600 text-white px-4 py-2 rounded-md text-sm hover:bg-gray-700 transition-colors w-full sm:w-auto"
          ...
          <div className="mt-6">
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="p-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between items-start sm:items-center">
                <h2 className="text-base sm:text-lg font-medium text-gray-900 mb-2 sm:mb-0">Transaction History</h2>
                <div className="inline-block relative w-full sm:w-auto">
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="appearance-none bg-white border border-gray-300 rounded-md pl-8 pr-8 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-800/20 w-full sm:w-auto"
              ...
              <div className="divide-y divide-gray-200">
                {transactions.length === 0 ? (
                  ...
                  transactions.map((transaction) => (
                    <div key={transaction._id} className="p-4 flex flex-col sm:flex-row items-start sm:items-center">
                      <div
                        className={`p-2 rounded-full mr-0 sm:mr-4 mb-2 sm:mb-0 ${
                      ...
                      <div
                        className={`text-sm sm:text-base font-medium mt-2 sm:mt-0 ${
            ...
            <div className="my-4 border-t border-gray-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
