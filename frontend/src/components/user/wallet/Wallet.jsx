...
const Wallet = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-20">
      <h1 className="text-3xl font-serif font-bold mb-8 text-center">My Wallet</h1>
      
      <div className="max-w-4xl mx-auto">
        {/* Balance Card */}
        <div className="bg-gradient-to-r from-orange-800 to-gray-900 rounded-xl text-white p-6 mb-8 shadow-lg">
