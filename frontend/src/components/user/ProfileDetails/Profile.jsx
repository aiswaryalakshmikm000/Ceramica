...
// import { setUserCredentials, selectUser } from "../../../features/auth/userAuthSlice";
...
//     isLoading,
//     error,
//   } = useShowProfileQuery(id, {
//     skip: !id, // Use URL id instead of currentUser?._id
//   });
...
//                     <img
//                       src={user.images} // Assuming 'images' is the field; adjust if it's 'avatar' or 'profileImage'
//                       alt={user.name}
...
//                   className="flex-1 bg-orange-800/90 text-white py-3 rounded-lg hover:bg-gray-700/90 transition-colors"
//                 >
//                   Edit Profile
//                 </button>
//                 <button 
...
const Profile = () => {
  ...
  useEffect(() => {
    if (userData) {
      setEmail(userData.email); // Pre-fill email from profile
    }
  }, [userData]);
