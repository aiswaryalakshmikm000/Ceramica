...
//       <h1 className="text-3xl font-serif font-bold mb-8 text-center">My Coupons</h1>
...
//                       <span className="text-xs text-gray-500">Valid until {coupon.validUntil}</span>
//                     </div>
...
const Coupons = () => {
  const [selectedCoupon, setSelectedCoupon] = useState(null); // Add state for selected coupon
