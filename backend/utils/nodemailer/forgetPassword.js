...
const sendResetPasswordMail=async(email,otp)=>{
    try {
        await mailSender(
            email,
            "CERAMICA - Password Reset Request",
            `
            <div style="font-family: Arial, sans-serif; color: #333;">
              <h2 style="color: #0a74da;">Password Reset Request</h2>
              <p>Dear user,</p>
              <p>We received a request to reset your password for your <strong>CERAMICA</strong> account. Please use the OTP code below to reset your password:</p>
              ...
              <p style="font-size: 12px; color: #777;">&copy; 2025 CERAMICA. All rights reserved.</p>
            </div>
            `
        )
